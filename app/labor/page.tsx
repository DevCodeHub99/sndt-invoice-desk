...
export default function LaborPage() {
  const { laborCharges, fetchLaborCharges, addLaborCharge, updateLaborCharge, deleteLaborCharge } = useLaborStore();
      ...
      >
        <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-4">
          ...
          <div className="flex flex-col-reverse sm:flex-row justify-end gap-3 pt-4">
            ...
            <Button type="submit">
              {editingLabor ? 'Save Changes' : 'Add Labor Charge'}
            </Button>
          </div>
        </form>
      </Modal>
